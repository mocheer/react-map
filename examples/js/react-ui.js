...
/***/ function(module, exports, __webpack_require__) {
	...
	//element
	//component
	const TextInput = __webpack_require__(168);
	const DataTable = __webpack_require__(169);
	const DataList = __webpack_require__(170);
	const ComboBox = __webpack_require__(171);
	const PageBox = __webpack_require__(172);
	//container
	const Panel = __webpack_require__(173);
	//
	var views = {
	    textinput: TextInput,
	    datatable: DataTable,
	...
	function createElement(type, target, props) {
	    ...
	    var actions = ReactUI.actions;
	    var stores = ReactUI.stores;
	    var temp;

	    if (!props.actions && actions && (temp = actions[type])) {
	        props.actions = temp;
	    }
	    if (!props.store && stores && (temp = stores[type])) {
	        props.store = temp;
	    }
	...
	(function (global, factory) {
	    global.document ? factory(global) : function (w) {
	        if (!w.document) {
	            throw new Error("ReactUI requires a window with a document");
	        }
	        return factory(w);
	    };
	...
	module.exports = { views: views, ReactUI: ReactUI };
...
/***/ function(module, exports, __webpack_require__) {
	...
	const React = __webpack_require__(1);
	//TODO action
	//getDefaultProps{buttonText,placeholder}
	const TextInput = React.createClass({displayName: "TextInput",
	    handleClick: function(event){
	        var text = this.refs.textinput.value;
	    },
	    render: function(){
	         return (
	             React.createElement("div", {className: "input-group TextInput"}, 
	                React.createElement("span", {className: "input-group-btn"}, 
	                    React.createElement("button", {className: "btn btn-default", type: "button", onClick: this.handleClick}, this.props.buttonText)
	                ), 
	                React.createElement("input", {type: "text", ref: "textinput", className: "form-control", placeholder: this.props.placeholder})
	            )
	         );
	     }
	})
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * store
	 */
	const DataTable = React.createClass({displayName: "DataTable",
	    getInitialState: function(){
	        return {
	    ...
	    render: function() {
	        ...
	        var headerColumns = columns.map(function(item,index){
	            if(item.headerText==="+"){
	                return React.createElement("th", {width: item.width, onClick: handleClick(item,event)}, React.createElement("a", {href: "javascript:void(0)"}, "+"))
	            }
	            return React.createElement("th", {width: item.width}, item.headerText);
	        });
	        ...
	        if(dataProvider){
	            dataRows =  dataProvider.map(function(data,rowid){
	                var dataColumns = columns.map(function(column,columnid){
	                    ...
	                    switch(type){
	                        case "rowid":
	                            return React.createElement("td", null, rowid)
	                        case "-":
	                            return React.createElement("td", {onClick: handleClick(data,event)}, React.createElement("a", {href: "javascript:void(0)", "data-rowid": rowid}, "-"));
	                        case "link":
	                            var linkUrl = data["link-"+dataField];
	                            if(linkUrl){
	                                return React.createElement("td", null, React.createElement("a", {href: linkUrl, target: "view_window"}, data[dataField]))
	                            }
	                        default:
	                            return React.createElement("td", null, data[dataField])
	                    }
	                });
	                return React.createElement("tr", {"data-rowid": rowid}, dataColumns)
	            });
	        }else{
	             var rowCount = 3;
	             dataRows = [];
	             for(var i = 0;i <rowCount; i++) {
	                   dataRows.push(React.createElement("tr", {"data-rowid": i}, React.createElement("td", {colSpan: columnCount})))
	             }
	        }
	        
	        return (
	           React.createElement("table", {className: "table table-hover table-striped table-bordered table-condensed DataTable"}, 
	              React.createElement("thead", null, React.createElement("tr", null, headerColumns)), 
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * store
	 */
	const DataList = React.createClass({displayName: "DataList",
	    getInitialState: function(){
	        return {
	            dataProvider:this.props.dataProvider
	        };
	    ...
	    render: function() {
	       ...
	       if(dataProvider){
	            dataRows =  dataProvider.map(function(data){
	                ...
	                return React.createElement("a", {href: "javascript:void(0)", className: "list-group-item"}, dataLabel)
	            });
	        }
	       return(
...
/***/ function(module, exports, __webpack_require__) {
	...
	const React = __webpack_require__(1);
	//TODO action
	const ComboBox = React.createClass({displayName: "ComboBox",
	    ...
	    render: function(){
	        var dataList;
	        var className = this.props.dropType;
	        if(this.state.expanded){
	            var dataProvider = this.state.dataProvider;
	            var dataRows =  dataProvider.map(function(data){
	                var dataLabel;
	                if(typeof(data)==="object"){
	                    dataLabel = data.label;
	                }else{
	                ...
	                return  React.createElement("li", null, React.createElement("a", {href: "javascript:void(0)"}, dataLabel))
	            });
	            dataList = React.createElement("ul", {className: "dropdown-menu"}, dataRows);
	            className += " open"
	        }
	       
	        return (
	            React.createElement("div", {className: className}, 
	                React.createElement("button", {className: "btn btn-default dropdown-toggle", type: "button", onClick: this.handleClick}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	const React = __webpack_require__(1);
	//TODO action
	const PageBox = React.createClass({displayName: "PageBox",
	    getDefaultProps : function () {
	        return {
	            count:0
	        };
	    ...
	    handleForward: function(event) {
	        ...
	        if(selectedIndex < this.state.count-1){
	    ...
	    render: function(){
	        ...
	        if(count > 0)
	        {
	            ...
	            for (var i=0;i < count;i++){
	                var li;
	                if(i===selectedIndex){
	                     li = React.createElement("li", {className: "active"}, React.createElement("a", {href: "javascript:void(0)"}, i))
	                }else{
	                     li = React.createElement("li", null, React.createElement("a", {href: "javascript:void(0)", onClick: this.handleClick}, i))
	                }
	                pageIndexs.push(li)
	            }
	        }
	        return (
	           React.createElement("nav", null, 
	                React.createElement("ul", {className: "pagination"}, 
	                    React.createElement("li", null, React.createElement("a", {href: "javascript:void(0)", onClick: this.handleBack}, React.createElement("span", null, "«"))), 
	                    pageIndexs, 
	                    React.createElement("li", null, React.createElement("a", {href: "javascript:void(0)", onClick: this.handleForward}, React.createElement("span", null, "»")))
	                )
	           )
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	const Panel = React.createClass({displayName: "Panel",
	    render: function(){
	        if(title = this.props.title){
	             title = React.createElement("div", {className: "panel-heading"}, title)
	        }
	        if(content = this.props.content){
	             content = React.createElement("div", {className: "panel-body"}, content)
	        }
	        if(footer = this.props.footer){
	             footer = React.createElement("div", {className: "panel-footer"}, footer)
	        }
	        return (
